...
bc. $ composer require "netcarver/textile {{ site.php_textile_version_minor }}.*"
...
bc. $ curl -L {{ site.github_url }}/archive/v{{ site.php_textile_version_latest }}.tar.gz | tar -zx

h2. Include PHP-Textile in your project
