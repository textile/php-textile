...
A lightweight markup language that takes (almost) plaintext and converts it into well formed HTML. You can read more about the format and test it at "TxStyle.org":http://txstyle.org/article/43/a-short-introduction.
