...
Textile is a humane web text generator. It takes lightweight, readable, plaintext-like syntax and converts it into well formed HTML. This repository contains a Textile parser for PHP.
