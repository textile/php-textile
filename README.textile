...
To start using textile in your project you need to make your project depend upon netcarver/textile and have composer take care of the installation and autoloading of the code for you. If you don't already have a @composer.json@ file in the root of your projet create one and paste one of the following into it...
...
p. Now you should be able to create a textile parser using a fully qualified namespace like this...
