...
A lightweight markup language that takes (almost) plaintext and converts it into well formed HTML. You can read about the format & use it live at "TxStyle.org":http://txstyle.org/article/43/a-short-introduction.

!https://travis-ci.org/textile/php-textile.png?branch=master!:https://travis-ci.org/textile/php-textile
...
bc. include 'path/to/src/Netcarver/Textile/Parser.php';
include 'path/to/src/Netcarver/Textile/DataBag.php';
include 'path/to/src/Netcarver/Textile/Tag.php';
