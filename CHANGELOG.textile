...
* Fix: relURL() now supports unicode characters (closes "#146":https://github.com/textile/php-textile/issues/146).
...
* Fix: Bugfix: Prevent hyphenated class on td cells adding incorrect style (closes "#164":https://github.com/textile/php-textile/issues/164).
* Various code cleanups, typo corrections and refactorings.
