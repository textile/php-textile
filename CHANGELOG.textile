...
* Add @Parser::setImages()@ and @Parser::isImageTagAllowed()@.
* Add @Parser::setBlockTags()@ and @Parser::isBlockTagAllowed()@ (closes "#138":https://github.com/textile/php-textile/issues/138).
* Add @Parser::setLinkRelationShip()@ and @Parser::getLinkRelationShip()@.
* Add @Parser::setLineWrap()@ and @Parser::isLineWrapAllowed()@.
