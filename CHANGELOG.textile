...
* Update @hasRawText()@ and @fPBr()@ to detect a wider range of raw HTML & XHTML

h2. "Version 2.5.2 - 2013/10/25":https://github.com/textile/php-textile/releases/tag/v2.5.2
...
h2. "Version 2.5.1 - 2013/01/01":https://github.com/textile/php-textile/releases/tag/v2.5.1
...
h2. "Version 2.5.0 - 2012/12/12":https://github.com/textile/php-textile/releases/tag/v2.5.0
...
* Follows "PSR-1 & PSR-2":https://github.com/php-fig/fig-standards/tree/master/accepted as far as possible *without* being PSR-0 compatible. So...
