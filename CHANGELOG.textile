...
h2. Changes in 2.5 branch (from 2.5.0)

* Remove horizontal alignement from inline elements (closes "#66":https://github.com/netcarver/textile/issues/66.)


h2. Changes in v2.5.0 (from 2.4.1)
